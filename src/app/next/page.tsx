    ...
    <main className="min-h-screen bg-[#020203] text-zinc-100">
          ...
          <div className="flex items-center gap-4">
            {firebaseUser ? (
              <div className="flex items-center gap-4">
                ...
                <Link href="/next/dashboard" className="rounded-full bg-white/5 border border-white/10 px-4 py-2 text-sm text-white transition hover:bg-white/10">
                  Dashboard
                </Link>
                <button 
                  onClick={() => logout()}
          ...
          <div className="relative max-w-3xl py-20 lg:py-32">
            ...
            <div className="ml-[-20px]">
              ...
              <div className="mt-12 flex flex-wrap items-center gap-4">
                {firebaseUser ? (
                  <Link href="/next/dashboard" className="group relative overflow-hidden rounded-full bg-white px-8 py-3.5 text-sm font-semibold text-black shadow-[0_0_20px_rgba(255,255,255,0.1)] transition-transform hover:scale-105 hover:bg-zinc-100">
        ...
        <div className="relative overflow-hidden rounded-[40px] border border-white/10 bg-gradient-to-br from-zinc-900 to-[#020203] p-8 md:p-16">
          ...
          <div className="relative z-20 max-w-xl">
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              <Link href="/next/trading" className="flex items-center gap-3 rounded-full bg-cyan-500 px-8 py-4 text-sm font-bold text-black transition-all hover:scale-105 hover:bg-cyan-400">
                Acceder a Trading
      ...
      <section className="mx-auto max-w-7xl px-6 pb-16">
        <div className="flex flex-col items-center justify-between gap-4 border-t border-white/10 pt-6 sm:flex-row sm:items-start">
          ...
          <Link href="/next/admin" className="text-zinc-700 transition-colors hover:text-white" title="Panel Administrativo">
